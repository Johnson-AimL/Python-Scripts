...
class mainApp(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.label = wx.StaticText(self,
                                   label="Welcome, RJW ELECTRICALS  - Stock Matching Program V1.0...................................###")
    ...
    def writeoutput(self):
        ...
        file_name = directory + '//output_' + now.strftime("%Y-%m-%d_%H-%M-%S") + '.xlsx'
    ...
    def on_submit(self, event):
        ...
        self.label.SetLabel("Processing Completed.")
