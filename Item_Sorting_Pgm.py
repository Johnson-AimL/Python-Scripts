...
class mainApp(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.SetBackgroundColour("#AEB65A")
        menubar = wx.MenuBar()
        fileMenu = wx.Menu()
        ...
        self.label = wx.StaticText(self, label="Welcome, RJW ELECTRICALS  - Stock Matching Program V2.0")
        ...
        self.SetTitle('RJW ELECTRICALS  - Stock Matching Program V2.0')
        self.Centre()
